        ...
        <div className="contact-grid">
          ...
          <div>
            <p style={{ color: "var(--text-muted)", fontSize: "1.05rem", lineHeight: "1.7", marginBottom: "2rem" }}>
              Feel free to reach out directly through any of the channels below. I'm actively looking for software engineering roles, technical consulting, and blockchain opportunities.
            </p>
